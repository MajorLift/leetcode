...
# Accepted 2023-01-28 23:52 UTC · Python · 80 ms · 14.1 MB
...
class Solution:
    def shortestPath(self, grid: List[List[int]], k: int) -> int:
        ...
        while pq:
            ...
            #     steps_target, removals_target = steps + manhattan_dist_to_target, removals + manhattan_dist_to_target
            #     if steps_target < min_steps_target:
            #         dist[-1][-1] = (steps_target, removals_target)
            #     heappush(pq, (steps_target, removals_target, target))
            #     continue
